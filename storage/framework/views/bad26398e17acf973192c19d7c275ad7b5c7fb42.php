...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="<?php echo e(URL::asset('css/style.css')); ?>"></link>
    ...
    <div id="container">
		<div id="row" class="main">
            ...
            <form id="file_form" class="form_class" action="<?php echo e(url('/upload')); ?>" method="post" enctype="multipart/form-data">
            <?php echo e(csrf_field()); ?>
				...
				<input type="hidden" name="img_path" id="img_path" value="<?php echo e(asset('upload/')); ?>">
			...
			<div id="sec_image" class="image_sec">
				<img src="<?php echo e(asset('images/frame.png')); ?>" id="frame_bg" style="display:none; position: relative;top: 0;left: 0;" width=500px height="500px">
				<img id="img_dis" src="" >	
...
<?php /**PATH C:\xampp\htdocs\appjar_pro\resources\views/welcome.blade.php ENDPATH**/ ?>